...
6. Preserve the raw-profile-photo contract while aligning the cabinet card and admin preview to the SVG's measured geometry.
...
- Cabinet changes avoid URL heuristics, schema changes, and shared upload utility changes because production image format cannot be inspected locally.
